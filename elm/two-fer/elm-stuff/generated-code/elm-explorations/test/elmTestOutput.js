...
var author$project$TwoFer$printTwoFer = function (name) {
	return 'One for ' + (name + ', one for me.');
};
var author$project$TwoFer$twoFer = function (name) {
	if (name.$ === 'Nothing') {
		return author$project$TwoFer$printTwoFer('you');
	} else {
		var val = name.a;
		return author$project$TwoFer$printTwoFer(val);
	}
};
...
var author$project$Test$Generated$Main531492105$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/slaymanc/code/exercism/elm/two-fer/tests/Tests.elm']),
		processes: 4,
		report: author$project$Test$Reporter$Reporter$ConsoleReport(author$project$Console$Text$UseColor),
		runs: elm$core$Maybe$Nothing,
		seed: 182560843512833
	},
...
_Platform_export({'Test':{'Generated':{'Main531492105':{'init':author$project$Test$Generated$Main531492105$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-68411.sock";
